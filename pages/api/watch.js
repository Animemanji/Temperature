...
export default async function handler(req, res, next) {
    ...
    try {
        ...
        const iframeArry = []
        const iframes = sectionsArray[0].querySelector("#aa-options").querySelectorAll("div").forEach(r => {
        ...
        const videoOptions = sectionsArray[0].querySelector(".video-options").querySelector(".d-flex-ch").querySelector("#ln0").querySelector("ul").querySelectorAll("li").forEach(r => {
            const a = r.querySelector("a")
            const dataArry = [];

            const data = a.querySelectorAll("span").forEach(r => {
